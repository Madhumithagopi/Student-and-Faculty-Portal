...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['name']) && !empty($_POST['regno']) &&!empty($_POST['email']) && !empty($_POST['phone_no']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])){
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')?'index.php':'index.php';
