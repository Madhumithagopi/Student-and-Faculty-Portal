...
unset($_SESSION['empid']);
    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                            ...
                            <input type="submit" class="pres" name="present" value="Present">
                            <input type="submit" class="abse" name="absent" value="Absent">
        ...
        <table class="table table-striped table-hover">
            ...
            echo "<tr>";
			$sql1="SELECT * FROM `msw_student`.`attendance` where sid='".$_SESSION['empid']."' and `ispresent`='present'";
			$res1= mysql_query($sql1);
            while($row1=mysql_fetch_array($res1)){
				$r=$row1['uid'];
            echo"<td>"; echo $i++;echo "</td>";
            
			echo"<td data-status='present'>";echo"<span class='label label-success'>";echo $row1['ispresent'];echo"</td>";
            echo"<td>"; echo $row1['date'];echo"</td>";
			
			$sql="SELECT * FROM `msw_faculty`.`faculty_details` where `empid`='".$_row1['uid']."'";
			$res= mysql_query($sql);
			...
			$i=1;
            echo "<tr>";
			$sql1="SELECT * FROM `msw_student`.`attendance` where sid='".$_SESSION['empid']."' and `ispresent`='absent'";
			$res1= mysql_query($sql1);
            while($row1=mysql_fetch_array($res1)){
				$r=$row1['uid'];
            echo"<td>"; echo $i++;echo "</td>";
           
			echo"<td data-status='absent'>";echo"<span class='label label-danger'>";echo $row1['ispresent'];echo"</td>";
            echo"<td>"; echo $row1['date'];echo"</td>";
			echo"</tr>";
			}
    }
			...
			$i=1;
            echo "<tr>";
			$sql1="SELECT * FROM `msw_student`.`attendance` where sid='".$_SESSION['empid']."'";
			$res1= mysql_query($sql1);
            while($row1=mysql_fetch_array($res1)){
				$r=$row1['uid'];
            echo"<td>"; echo $i++;echo "</td>";
         
			if($row1['ispresent']=="present")
			{
			echo"<td data-status='present'>";echo"<span class='label label-success'>";echo $row1['ispresent'];echo "</span>";echo"</td>";
			}
			if($row1['ispresent']=="absent")
			{
			echo"<td data-status='absent'>";echo"<span class='label label-danger'>";echo $row1['ispresent'];echo "</span>";echo"</td>";
			}
			echo"<td>"; echo $row1['date'];echo"</td>";
