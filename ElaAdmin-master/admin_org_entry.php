...
$sql_ins=mysql_query("INSERT INTO organisation_details VALUES(							
							NULL,
							'$orgid',
							'$orgname' ,
							'$orgcategory',
	...
	?>
        ...
        <div class="content">
            <div class="animated fadeIn">
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">ORGANISATION DETAILS ENTRY </h4>
                            </div>
    ...
    <div>
   	  <table border="0" cellpadding="4" cellspacing="0">
        	<tr>
            	...
            	<td>
                	<input type="text" name="orgidtxt" class="text" placeholder="Organisation Id" required>
                </td><td></td>
				<td class="label"><label for="nametxt">Organisation Name</td>
            	<td>
                	<input type="text" name="nametxt" class="text" placeholder="Organisation Name">
                </td>
            </tr>
            <tr>
            </tr>
			...
			<td class="label"><label for="addresstxt">Address</td>
               <td>
                	<textarea rows="2" cols="26" type="text" name="addresstxt" value="" placeholder="Address" required></textarea>           
              </td>
            	<td></td>
...
<option value="Goverment">Government</option>
            ...
            <tr>
			<td></td>
			<td><a href="admin_org_details.php"><input class="btn" type="button" name="btn_view" title="View Students" value="List" style="width:120px;"></a>
            </td>
                <td colspan="2">
