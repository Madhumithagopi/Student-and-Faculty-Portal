...
$sql_ins=mysql_query("INSERT INTO resource_person VALUES(	NULL,						
							'$resid',
							'$name',
							'$designation' ,
							'$phone',
	...
	?>
        ...
        <div class="content">
            <div class="animated fadeIn">
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">RESOURCE PERSONS ENTRY </h4>
                            </div>
<div id="style_informations">
    ...
    <div>
   	 <table border="0" cellpadding="4" cellspacing="0">
        	<tr>
            	<td class="label"><label for="restxt">Resource Id</td>
               <td>
                	<input type="text" name="restxt" class="text" placeholder="Resource Id" required>
              </td><td></td>
				<td class="label"><label for="nametxt"> Resource Person Name</td>
            	<td>
                	<input type="text" name="nametxt" class="text" placeholder="Resource Person Name" required>
                </td>
            </tr>
           <tr>
            	<td class="label"><label for="desitxt">Designation</td>
                <td>
                	<input type="text" name="desitxt" class="text" placeholder="Designation" required>
                </td><td></td>
			  ...
			  <tr>
            	...
            	<td>
                	<input type="text" name="timestxt" class="text" placeholder="Times(Visited)" required></td>
        	 <td></td>
			  ...
			  <td class="label"><label for="addrtxt">Address</td>
               <td>
                	<textarea rows="2" cols="26" type="text" name="addrtxt" value="" placeholder="Address" required></textarea>
              </td>
			  </tr>
            <tr>
			<td></td>
			<td><a href="admin_resource_list.php"><input class="btn" type="button" name="btn_view" value="Persons" style="width:120px;"></a>
            </td>
                <td colspan="2">
