...
if(isset($_GET['rs_id']))
	...
	if($opr=="del")
{
	$del_sql=mysql_query("DELETE FROM organisation_details WHERE org_id=$id");
	if($del_sql)
	...
	?>
        ...
        <div class="content">
            <div class="animated fadeIn">
                   ...
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">ORGANISATION LIST </h4>
                            </div>
							<div id="style_div" >
<form method="post">
<table width="755">
...
<td><input type="text" class="text" name="searchtxt"  autocomplete="off" placeholder="Search"/>
        ...
        <td>
        	...
        	<a href="admin_org_entry.php"><input type="button" name="butAdd" value="Add New" class="btn" /></a>
    </tr>
</table>
</form>
</div>
...
<form method="post">
	...
	if(isset($_POST['searchtxt']))
		$key=$_POST['searchtxt'];	
	if($key !="")
		$sql_sel=mysql_query("SElECT * FROM organisation_details WHERE org_name like '%$key%' OR org_id like '%$key%' OR org_category like '%$key%' OR address like '%$key%'");
	else
		 $sql_sel=mysql_query("SELECT * FROM organisation_details");	
    $i=0;
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td><a href="everyone.php?tag=admin_org_update&opr=upd&rs_id=<?php echo $row['org_id'];?>" title="Update"><img src="picture/update.png"/></a></td>
            <td><a href="?tag=admin_org_details&opr=del&rs_id=<?php echo $row['org_id'];?>" title="Delete"><img src="picture/delete.png" /></a></td>
             </tr>
    <?php	
    }	
    ?>
