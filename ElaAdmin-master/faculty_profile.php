      ...
      <div class="w3-white w3-card-4">
		...
		<tr><img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" height="200" width="200" class="img-thumnail" />  </tr>
		 ...
		 <td><?php echo $row['email']; ?></td></tr>
		  ...
		  <!--tr><td><h3><b>Semester-2</b></h3></td></tr>
		  <tr><td><h3><b>Semester-3</b></h3></td></tr>
		  <tr><td><h3><b>Semester-4</b></h3></td></tr!-->
		  
		  <?php 
		    
		 $sql1="SELECT count(*) as one FROM `msw_student`.`student_details` where `fac_id`='".$_SESSION['empid']."' and batch='2018'";
		$result=mysqli_query($connect,$sql1);
$values=mysqli_fetch_assoc($result);
$num_rows=$values['one'];

		?>
			<tr><td>Number of 1st Years</td><td><? echo $num_rows;?></td></tr>
			<?php 
		    
		 $sql1="SELECT count(*) as two FROM `msw_student`.`student_details` where `fac_id`='".$_SESSION['empid']."' and batch='2017'";
		$result=mysqli_query($connect,$sql1);
$values=mysqli_fetch_assoc($result);
$num_rows=$values['two'];
		?>
			<tr><td>Number of 2nd Years</td><td><? echo $num_rows;?></td></tr>
