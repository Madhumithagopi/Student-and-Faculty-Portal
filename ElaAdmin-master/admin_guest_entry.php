...
$sql_ins=mysql_query("INSERT INTO guest_lectures VALUES(							
							NULL,
							'$title',
							'$date',
							'$id'
	...
	?>
        ...
        <div class="content">
            <div class="animated fadeIn">
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">GUEST LECTURES ENTRY </h4>
                            </div>
<div id="style_informations">
    ...
    <div>
   	  <table border="0" cellpadding="4" cellspacing="0">
                ...
                <td>
                	<input type="text" name="titletxt" class="text" placeholder="Title" required>
                </td>
            </tr>
            <tr>
            	<td class="label"><label for="datetxt">Date</td>
               <td>
                	<input type="date" name="datetxt" class="text" required>
              </td>
        	</tr>
            <tr>
			
			<td><a href="admin_guest_list.php"><input class="btn" type="button" name="btn_view" value="Lectures" style="width:120px;"></a>
            </td>
                <td colspan="2">
