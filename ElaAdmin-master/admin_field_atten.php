	...
	?>
        ...
        <div class="content">
            <div class="animated fadeIn">
                   ...
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">STUDENT ATTENDANCE LIST </h4>
                            </div>
							<div id="style_div" >
<form method="post">
<table width="755">
...
<form method="post">
	...
	if(isset($_POST['searchtxt']))
		$key=$_POST['searchtxt'];	
	if($key !="")
		$sql_sel=mysql_query("SElECT * FROM `msw_student`.`attendance` WHERE date like '%$key%' OR sid like '%$key%' OR ispresent like '%$key%' OR uid like '%$key%'");
	else
