...
if(isset($_POST['btn_upd'])){
	$orgid=$_POST['orgidtxt'];
	$orgname=$_POST['nametxt'];
	$orgcategory=$_POST['catetxt'];
	$address=$_POST['addresstxt'];
	$sql_update=mysql_query("UPDATE organisation_details SET 
	                        org_id='$orgid',
							org_name='$orgname' ,
							...
							");
	if($sql_update==true)
		header("location:admin_org_details.php");
	else
...
if($opr=="upd")
{
	$sql_upd=mysql_query("SELECT * FROM organisation_details WHERE org_id=$id");
	...
	?>
        ...
        <div class="content">            
            <div class="animated fadeIn">                
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">ORGANISATION LIST UPDATE </h4>
                            </div>	
<div id="style_informations">
    ...
    <div>
   	  <table border="0" cellpadding="4" cellspacing="0">
        	<tr>
            	<td class="label"><label for="orgidtxt">Organisation Id</td>
            	<td>
                	<input type="text" name="orgidtxt" class="text" value="<?php echo $rs_upd['org_id'];?>" required>
                </td><td></td>
				<td class="label"><label for="nametxt">Organisation Name</td>
            	<td>
                	<input type="text" name="nametxt" class="text" value="<?php echo $rs_upd['org_name'];?>" required>
                </td>
            </tr>
            <tr>
            </tr>
            <tr>
			<td class="label"><label for="addresstxt">Address</td>
               <td>
                	<textarea rows="2" cols="26" type="text" name="addresstxt" value="" required><?php echo $rs_upd['address'];?></textarea>
              </td>
            	<td></td>
				<td class="label"><label for="catetxt">Organisation Category</td>
            	<td><select class="text" name="catetxt" class="text" required>
				<option value="NULL">select Category</option>
<option value="Psychaitry"<?php if($rs_upd['org_category']=="Psychaitry"){ echo "selected";}?>>Psychaitry</option>
<option value="HRM" <?php if($rs_upd['org_category']=="HRM"){ echo "selected";}?>>HRM</option>
<option value="DM" <?php if($rs_upd['org_category']=="DM"){ echo "selected";}?>>DM</option>
<option value="NGO" <?php if($rs_upd['org_category']=="NGO"){ echo "selected";}?>>NGO</option>
<option value="Goverment" <?php if($rs_upd['org_category']=="Goverment"){ echo "selected";}?>>Government</option>
</select>
</td>
            </tr>
            
            <tr>
			<td><a href="admin_org_details.php"><input type="button" name="btn_view" title="View Students" value="Back" class="btn"></a>
            </td>
			<td><a href="admin_org_details.php"><input class="btn" type="button" name="btn_view" title="View Students" value="List"/></a>
            </td>
                <td colspan="2">
