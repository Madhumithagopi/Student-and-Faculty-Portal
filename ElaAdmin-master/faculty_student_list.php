    ...
    <div class="table-wrapper">
		...
		<?php
			...
			<?php
				...
				$d=date("Y")-1;
			$sql1="SELECT * FROM `msw_student`.`student_details` where `facid2`='".$_SESSION['empid']."' and `batch`=$d";
			...
			$sql="SELECT * FROM `msw_admin`.`organisation_details` where `org_id`='".$org."'";
			//echo $sql;
			$res= mysql_query($sql);
			...
			$r2=$row['org_category'];
			 ...
			 echo "<td>";echo $r;echo"</td>";
            echo"<td>"; echo $r2 ;echo"</td>";
			echo"</tr>";
			...
			<?php
				...
				$d=date("Y")-2;
			$sql1="SELECT * FROM `msw_student`.`student_details` where `facid4`='".$_SESSION['empid']."' and `batch`=$d";
			$res1= mysql_query($sql1);
            while($row1=mysql_fetch_array($res1)){
				echo "<tr>";
            echo"<td>"; echo $i++;echo "</td>";
