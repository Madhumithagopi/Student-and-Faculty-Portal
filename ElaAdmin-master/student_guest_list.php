...
unset($_SESSION['empid']);
	...
	?>
        ...
        <div class="table-title">
            <div class="row">
                <div class="col-sm-6"><h2>GUEST LECTURE LIST</h2></div>
	...
	$i=1;
			...
			$sql1="SELECT * FROM `msw_admin`.`guest_lectures` where res_id='".$resid."'";
            ...
            while($row1=mysql_fetch_array($res1)){
			 ...
			 echo "<td>";echo $re;echo"</td>";
            echo "<td>";echo $row1['title_of_lecture'];echo"</td>";
