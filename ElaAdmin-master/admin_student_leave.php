...
if($opr=="upd")
{
	$sql_upd=mysql_query("SELECT * FROM student_leave_request");
	...
	?>
        ...
        <div class="content">
            <div class="animated fadeIn">
                   ...
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">STUDENT LEAVE REQUEST LIST </h4>
                            </div>
							<div id="style_div" >
<form method="post">
<table width="755">
...
<form method="post">
	...
	if(isset($_POST['searchtxt']))
		$key=$_POST['searchtxt'];	
	if($key !="")
		$sql_sel=mysql_query("SElECT * FROM student_leave_request WHERE regno like '%$key%' OR name like '%$key%' OR faculty_id like '%$key%' OR leave_type like '%$key%' OR reason like '%$key%' OR status like '%$key%' OR from_date like '%$key%' OR to_date like '%$key%' OR org_permission like '%$key%'");
	else
		 $sql_sel=mysql_query("SELECT * FROM student_leave_request");   
   $i=0;
    ...
    ?>
	  ...
	  <td><?php echo $i;?></td>
			...
			<td><?php echo $row['org_permission'];?></td>
