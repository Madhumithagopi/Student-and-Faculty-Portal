...
if(isset($_POST['btn_upd'])){
	...
	$date=$_POST['datetxt'];
	$sql_update=mysql_query("UPDATE guest_lectures SET 
	                        title_of_lecture='$title',
							date='$date'
							WHERE
								res_id=$id
							");
	if($sql_update==true)
		header("location:admin_guest_list.php");
	else
...
if($opr=="upd")
{
	$sql_upd=mysql_query("SELECT * FROM guest_lectures WHERE res_id=$id");
	...
	?>
        ...
        <div class="content">            
            <div class="animated fadeIn">                
                   <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">GUEST LECTURES UPDATE </h4>
                            </div>	
<div id="style_informations">
    ...
    <div>
   	  <table border="0" cellpadding="4" cellspacing="0">
                  <tr>
            	<td class="label"><label for="titletxt">Title</td>
                <td>
                	<input type="text" name="titletxt" class="text" value="<?php echo $rs_upd['title_of_lecture'];?>"required>
                </td>
            </tr>
            <tr>
            	<td class="label"><label for="datetxt">Date</td>
               <td>
                	<input type="date" name="datetxt" class="text" value="<?php echo $rs_upd['date'];?>"required>
              </td>
        	</tr>
            <tr>
			<td>            	<a href="admin_guest_list.php"><input type="button" name="btn_view" title="View Students" value="Back" class="btn"></a>
            </td>
			<td><a href="admin_guest_list.php"><input class="btn" type="button" name="btn_view" title="View Students" value="Lectures"/></a>
            </td>
                <td colspan="2">
