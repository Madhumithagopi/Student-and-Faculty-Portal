      ...
      <div class="w3-white w3-card-4">
		...
		<tr><img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" height="200" width="200" class="img-thumnail" />  </tr>
		 ...
		 <td><?php echo $row['email']; ?></td></tr>
          ...
          <tr><td><h3><b>FACULTY GUIDE</b></h3></td></tr>
