...
if(isset($_POST['edit_profile']))
{
 ...
 else
 {
  ...
  {
   $data[] = array(
    ':password'  => password_hash($_POST["password"], $row["password"])
   );
   $query = 'UPDATE tbl_twitter_user SET username = "'.$_POST["username"].'", password ="'.$_POST["password"].'", name = "'.$_POST["name"].'", profile_image = "'.$file_name.'", bio = "'.$_POST["bio"].'" WHERE user_id = "'.$_SESSION['user_id'].'"';
   echo $query;
  }
  else
  {
